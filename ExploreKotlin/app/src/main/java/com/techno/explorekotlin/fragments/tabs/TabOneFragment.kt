package com.techno.explorekotlin.fragments.tabs
 ...
 * [TabOneFragment.OnFragmentInteractionListener] interface
...
class TabOneFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TabOneFragment {
