package com.techno.explorekotlin.fragments
...
class Menu1 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        textView = rootView.findViewById<TextView>(R.id.tvMenuTitle)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): Menu1 {
            val fragment = Menu1()
            val args = Bundle()
