package com.techno.explorekotlin.utils.FragmentNav
...
public constructor(builder: Builder, savedInstanceState: Bundle?) {

    @IdRes
    public val mContainerId: Int
    public val mFragmentStacks: MutableList<Stack<Fragment>>
    public val mFragmentManager: FragmentManager
    public val mDefaultTransactionOptions: FragNavTransactionOptions?
    /**
    ...
    var currentStackIndex: Int = 0
        public set
    public var mTagCount: Int = 0
    public var mCurrentFrag: Fragment? = null
    public var mCurrentDialogFrag: DialogFragment? = null
    public val mRootFragmentListener: RootFragmentListener?
    public val mTransactionListener: TransactionListener?
    public var mExecutingTransaction: Boolean = false
     ...
     */
    public fun initialize(@TabIndex index: Int) {
        currentStackIndex = index
    ...
    public fun getRootFragment(index: Int): Fragment {
        var fragment: Fragment? = null
     ...
     */
    public fun reattachPreviousFragment(ft: FragmentTransaction): Fragment? {
        val fragmentStack = mFragmentStacks[currentStackIndex]
        var fragment: Fragment? = null
        if (!fragmentStack.isEmpty()) {
     ...
     */
    public fun detachCurrentFragment(ft: FragmentTransaction) {
     ...
     */
    @CheckResult
    public fun generateTag(fragment: Fragment): String {
     ...
     */
    public fun executePendingTransactions() {
    ...
    /**
     * public helper function to clear out the fragment manager on initialization. All fragment management should be done via FragNav.
     */
    public fun clearFragmentManager() {
     ...
     */
    @CheckResult
    public fun createTransactionWithOptions(transactionOptions: FragNavTransactionOptions?): FragmentTransaction {
     ...
     */
    public fun restoreFromBundle(savedInstanceState: Bundle?, rootFragments: List<Fragment>?): Boolean {
    ...
    //@IntDef(NO_TAB.toLong(), TAB1.toLong(), TAB2.toLong(), TAB3.toLong(), TAB4.toLong(), TAB5.toLong())
    ...
    class Builder(public val mSavedInstanceState: Bundle?, public val mFragmentManager: FragmentManager, public val mContainerId: Int) {
        public var mRootFragmentListener: RootFragmentListener? = null
        @TabIndex
        public var mSelectedTabIndex = TAB1
        public var mTransactionListener: TransactionListener? = null
        public var mDefaultTransactionOptions: FragNavTransactionOptions? = null
        public var mNumberOfTabs = 0
        public var mRootFragments: MutableList<Fragment>? = null
        ...
        fun rootFragment(rootFragment: Fragment): Builder {
            ...
            mNumberOfTabs = 1
            return rootFragments(mRootFragments as MutableList<Fragment>)
        }
    ...
    companion object {
        ...
        public val MAX_NUM_TABS = 5

        // Extras used to store savedInstanceState
        public val EXTRA_TAG_COUNT = FragNavController::class.java.name + ":EXTRA_TAG_COUNT"
        public val EXTRA_SELECTED_TAB_INDEX = FragNavController::class.java.name + ":EXTRA_SELECTED_TAB_INDEX"
        public val EXTRA_CURRENT_FRAGMENT = FragNavController::class.java.name + ":EXTRA_CURRENT_FRAGMENT"
        public val EXTRA_FRAGMENT_STACK = FragNavController::class.java.name + ":EXTRA_FRAGMENT_STACK"
